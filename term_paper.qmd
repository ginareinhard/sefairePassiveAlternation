...
freq_complement_bind <- freq_complement
colnames(freq_complement_bind)[1] <- "level"
freq_complement_bind$factor <- "Complément d'agent"

freq_table <- bind_rows(freq_animacy_bind, freq_gender_bind, freq_complement_bind) |> 
