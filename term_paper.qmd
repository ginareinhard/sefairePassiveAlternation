...
**Interaction**: @raineri_analyse_2010 [94] suspects that [se faire]{.smallcaps}'s animacy (almost-) constraint restricts verb selection and provides an explanation for the construction's incompatibility with certain verbs (i.e. not all verbs can occur with animate subjects).
