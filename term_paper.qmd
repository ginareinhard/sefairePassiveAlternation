...
-   Writing-Original Draft (including Code)
    ...
    -   @sec-etre, contributions to @sec-debate and @sec-sefaire-context, @sec-subj-resp (Subject Animacy first and last paragraph, Gender, Complément d'agent, contributions to Modal Verb), contributions to @sec-adversativity, @sec-aspectuality (including verb cluster table in appendix)
