...
Another indication of the association of [se faire]{.smallcaps} with progressive aspect is its frequent co-occurrence with periphrastic constructions that mark ongoing or recently initiated actions, such as *être en train de*, *venir de*, and *aller* + infinitive. These periphrastic constructions, which mark dynamic or ongoing actions, have been shown to co-occur more naturally with [se faire]{.smallcaps} than [être.]{.smallcaps} This is because [se faire]{.smallcaps} conveys a dynamic, ongoing action compared to the more stative [être \[]{.smallcaps}@spang-hanssen_quelques_1967: 141; @novakova_construction_2009: 115-117; @raineri_analyse_2010: 90-91\].
