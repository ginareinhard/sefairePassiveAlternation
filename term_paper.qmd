...
In terms of aspectuality and TAM, our model did not yield any significant effects. This result contradicts previous observations, such as those by @bellec_construction_2014 [209], who notes that [être]{.smallcaps} is more likely to describe an outcome or endpoint, while [se faire]{.smallcaps} is more likely to occur with verbs referring to progressive or ongoing actions. Based on this, we had expected progressive aspect to favour [se faire]{.smallcaps}. In our analysis, TAM was broadly grouped into two categories: "progressive" and "non-progressive". We chose this approach facilitate our annotation and it was necessary to ensure inter-annotator agreement, especially given that neither annotator was a native French speaker, but it may also have led to limitations. The broad classification sometimes disregarded context-specific nuances, so the overall annotation may not have been fine-grained enough to capture subtler aspectual differences. This may partly account for the lack of a significant TAM effect in our results.

Another aspectual factor that is not included in our note is telicity. According to @bellec_construction_2014 [209], être tends to express an outcome or endpoint, whereas [se faire]{.smallcaps} is more typical of ongoing actions. This contrast may reflect a broader telic/atelic distinction in which telic verbs favour [être]{.smallcaps} and atelic verbs - denoting indefinite or ongoing actions (e.g. perception verbs) - tend to occur with [se faire]{.smallcaps}. This pattern could also overlap with the verb cluster factor. Future research could include telicity.

One general limitation of our study is that the predictions of our model do not directly reflect real-life language use, as [être]{.smallcaps} is far more common than [se faire]{.smallcaps}, which is comparatively rare (ratio in ParlaMint: 324,836 (38.300) être: 1,254 se faire). We created a balanced dataset based on [se faire]{.smallcaps} lemmas to prevent our model from being dominated by frequency effects produced by extreme data unbalance.[^4]. This approach allowed us to investigate the factors influencing passive choice and their complex interplay. However, it must be kept in mind that this ratio is artificial does not reflect the reality of passive use, in which [être]{.smallcaps} is chosen as the default in most contexts, and [se faire]{.smallcaps} remains a marked exception.
