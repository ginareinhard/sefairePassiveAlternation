...
There are multiple ways of expressing passive in French: The most common way of expressing passive in French is via être, as in *Les députés sont élus* 'The members of parliament are elected'.

However, alternatively, one might use *se faire* to express passivity. But when is se faire chosen, or even preferred over the canonical passive? - what exactly determines this choice, what makes a speaker say “….” instead of “…”? As se faire is far more frequently used in spoken than in written language it is mostly produced spontaneously and chosen unconsciously/ without much previous thought. -\> chosen to convey a certain sense/ meaning or unconsciously put emphasis on something that être cannot capture?
...
This alternation, and specifically [se faire]{.smallcaps}, has been widely investigated and discussed, for example by @bellec_construction_2014, @gaatone_desagreable_1983, @koenig_semantic_1992, @kupferman_construction_1995, @labelle_anticausativizing_2013, @novakova_construction_2009, @raineri_analyse_2010, and @tasmowski-de_ryck_causatif_1987. However, the analyses have not yielded a definitive answer and suggest that the construction is quite nuanced: One the one hand, quantitative and qualitative analysis agree that se faire heavily favours animate subjects [e.g. @novakova_construction_2009, @koenig_semantic_1992]. This, in turn, is often understood to indicate active involvement of the subject, despite the fact that the referent of the subject is undergoing the embedded action (given the nature of the passive). Some go as far as to state that subjects of se faire constructions are always responsible for the action happening to them, while others refer to subject affectedness (or subject intentionality/ subject dynamism). Connected to this is also the debate of passivity and causativity: When the subject of se faire constructions is commonly both the initiator and the undergoer (for example …), it has been disputed whether the construction should even be considered passive at all. and where to draw the line?

Adversativity: Another factor that has been suggested to influence passive choice is adversativtiy. @gaatone_desagreable_1983 claims that passive se faire constructions often, and usually, carry a negative sense (comapred to être which is considered more neutral). Speakers may prefer se faire over être to express that the subject is negatively affected by the consequence.

Aspectuality: ....

<!-- establish research problem -> show research gap and how our study aims to fill that (method)-->

Thus, there exists extensive research on the alternation and the subtle differences of both passive variants. However, to our knowledge, no study thus far has investigated the exact factors predicting [se faire]{.smallcaps} over [être]{.smallcaps} using logistic regression modelling. Our study aims to fill that research gap: Using a quantitative, multivariate, probabilistic approach to model corpus data, we investigate the factors that influence the choice between se faire and être in the passive alternation in spoken French. Specifically, we aim to understand what factors contribute to speakers’ preference for one construction over the other. Logistic regression is popular in linguistic analysis due to its... and is specifically well-suited for linguistic analysis of alternations… [@gries_statistics_2021]. It has been successfully employed for investigation of passive variation in other languages, such as English [@bohmann_large-scale_2023, @hundt_be-_2024] and Swedish [@cuypere_corpus-based_2014]. Therefore, such a model promises to yield insightful results which may contribute to the discussion of the passive alternation, potentially revealing new insights into the use of both [se faire]{.smallcaps} and \[être\]{smallcaps}.
