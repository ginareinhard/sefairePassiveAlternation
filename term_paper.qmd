...
Interpretation of Subject Animacy × Adversativity: For animate subjects, *se faire* is highly likely to occur, regardless of whether the construction is adversative or not. In contrast, for inanimate subjects, adversative constructions are more frequently realised with *se faire*, while non-adversative constructions are less likely to appear with this form.
