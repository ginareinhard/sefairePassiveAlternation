...
Levels are by default ordered alphabetically. We change the reference levels to the most "standard" case.
...
+--------------------+-----------------+------------------------------------------+
| Subject animacy    | subj_animacy    | inanimate, animate                       |
+--------------------+-----------------+------------------------------------------+
| Subject gender     | subj_gender     | masculine, feminine                      |
+--------------------+-----------------+------------------------------------------+
| Complément d'agent | agent_pp        | 0, par, de // 0, present                 |
+--------------------+-----------------+------------------------------------------+
| Modal              | modal           | no, yes                                  |
+--------------------+-----------------+------------------------------------------+
...
+--------------------+-----------------+------------------------------------------+
| Adversativity      | adversativity   | non-adversative, adversative             |
+--------------------+-----------------+------------------------------------------+
