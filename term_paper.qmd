...
This question has been studied and investigated by numerous scholars, and as usually, the answer seems to be “it’s complicated”. Clearly, there are nuances to this: One the one hand, quantitative and qualitative analysis agree that se faire heavily favours animate subjects. This, in turn, is often understood to indicate active involvement of the subject, despite the fact that the referent of the subject is undergoing the embedded action (given the nature of the passive). Some go as far as to state that subjects of se faire constructions are always responsible for the action happening to them, while others refer to subject affectedness (or subject intentionality/ subject dynamism. Connected to this is also the debate of passivity and causativity: when the subject is both the initiator and the undergoer of an action (for example …), can the construction even be considered passive at all? and where to draw the line?

Adversativity: Adversativity is another factor that has been suggested to influence passive choice: … claim that se faire constructions often carry a negative sense..

Aspectuality: ....

<!-- establish research problem -> show research gap and how our study aims to fill that (method)-->

Thus, there exists extensive research on the alternation and their subtle differences. However, to our knowledge, no study thus far has investigated the exact factors predicting se faire over etre using logistic regression modelling. Logistic regression is popular in linguistic analysis due to its... and is specifically well-suited for linguistic analysis of alternations… has been successfully employed for investigation of passive variation in other languages, such as English [@bohmann_large-scale_2023, @hundt_be-_2024] and Swedish [@cuypere_corpus-based_2014] . Therefore, it promises to yield insightful results which will contribute to the discussion of… Our study aims to fill that research gap: by investigating the factors ...
...
We then report the results of our study in @sec-results, interpreting them within the same main concepts previously introduced: subject responsibility (@sec-results-subj-resp), adversativity (@sec-results-adversativity), and aspectuality (@sec-results-aspectuality). This is followed by the discussion (@sec-discussion), in which our findings are embedded with the previous literature and our results are evaluated in the light of the larger research picture. In the same vein, the limitations of our study are noted and discussed.

The paper concludes with @sec-conclusion, which consisely summarises our main findings and how they relate to passive alternation research, and provides an outlook for future research.
...
The remaining factors used to test subject responsibility (subject gender, complement d'agent, modal) did not yield significant effects. This may be taken as further indication for... / this may further strengthen an argument against subject responsibility and toward subject affectness// The absence of additional significant effects related to subject responsibility may further support this notion.
