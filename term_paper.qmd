...
```{r animacy-descriptive-tables, include=FALSE}
...
Mode: animate 704 animate (300 etre, 504 se faire); 360 inanimate (332 etre, 28 se faire); inanimate se faire only 0.026 percent of the data.

Plots (Elens Textbook Chapter 10)
...
In se faire passive constructions, the subject is animate the great majority of the time. For être, the animacy is more evenly distributed, with a slight tendency toward inanimate subjects.

very different distribution for non-adversative constructions: in être, most non-adversative construtions are with inanimate subjects while for se faire, most non-adversative constructions are with animate subjects.
