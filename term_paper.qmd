...
We automatically extracted a sample of 1,193 *se faire* + infinitive constructions from the ParlaMint 2.0 corpus on Sketch Engine \[source?\] using a CQL expression. After extraction, we manually filtered the data to exclude false-positive constructions (i.e. constructions that were not *se faire* + infinitive constructions) and those that did not fulfil our predefined criteria for *se faire* passives (see below). The final sample comprised 507 \[count with inline code\] *se faire* passives. We then annotated the lemmas of these constructions and relevant linguistic features, such as verb form, subject animacy and grammatical gender, in order to prepare the data for statistical modelling.
...
We expect phrases with *de* to have an even stronger effect than phrases with *par*, as they typically refer to less agentive or abstract sources (instead of agents), contradicting the dynamic nature of the *se faire* passive, which typically occurs with adversative or strongly agentive actions. To examine this, we will test the interaction between the compément d'agent and the verb cluster??, as we expect the *se faire* passive to be favoured by dynamic and adversative verbs (see seq-XXX).
...
-   @da2022alternance showed that the semantic class of the verb plays a crucial role in the use of the passive voice. In their study, 85% of *frapper* class verbs occurred in passive constructions, while only 15% were used in the active voice. This is consistent with findings from journalistic English, where verbs describing violent actions are often used in the passive voice (source). According to @da2022alternance, this preference can be explained by two factors: (1) the topical character of the affected patient, which makes it more likely to be promoted to the subject position, and (2) the possibility of the omission of an unknown or less salient agent.
    ...
    -   Frapper-type verbs (highly dynamic, adversative): strong preference for the passive voice, might also prefer se faire passives, contexts that emphasise the subject's affectedness
    ...
    -   Neutral verb classes (e.g. psychological, behavioural, movement, transfer): do not show a strong passive preference, distribution on être and se faire passives may depend on additional factors ?

-   se faire passives might be particularly favoured by highly dynamic, adversative verbs such as *frapper*, while verb classes that favour active constructions (e.g. communicative verbs) might be less compatible. ?

+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Verb cluster                                                      | hypothesised passive preference | Verb examples                                                                                                                                                                                                                       |
+===================================================================+=================================+=====================================================================================================================================================================================================================================+
| giving, depriving (don, privation)                                | se faire                        | aider (*une personne victime, à 57 ans, d'' un accident entraînant l'' apparition d'' un handicap et qui se ferait aider pendant dix, quinze, voire vingt ans par son conjoint sans demander la PCH.*)                              |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| entering, leaving (entrée, sortie)                                | se faire                        | engager (*cela répond à votre attente à l'' égard de fonctionnaires qui quitteraient l'' administration pour se faire engager par ailleurs au moyen de contrats de forme différente.*)                                              |
|                                                                   |                                 |                                                                                                                                                                                                                                     |
...
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| movement in place (mouvement sur place)                           | se faire                        |                                                                                                                                                                                                                                     |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| equipping, disarming (munir, démunir)                             | se faire                        | vacciner (*Il faut une prescription pour se faire vacciner contre la grippe en pharmacie*)                                                                                                                                          |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| transformation, change (transformation, changement)               | se faire                        | remplacer (*afin que le premier puisse se faire remplacer par le second*)                                                                                                                                                           |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| realisation, preparation (réalisation, mise en état)              | se faire                        | photographier (*J '' ajoute la diminution du nombre de points où l'' on peut se faire photographier et déposer son dossier en vue de faire établir ou renouveler sa carte nationale d'' identité ou son passeport*.)                |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| physical states and behaviours (états physiques et comportements) | être                            | aider (*afin de permettre aux enfants victimes de haine en ligne de se faire aider même si leurs parents n'' en sont pas informés.*)                                                                                                |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| locative (locatif)                                                | être                            | accepter (*Oliver Wendell Holmes écrit ainsi que " la meilleure épreuve de vérité est le pouvoir d'' une pensée de se faire accepter dans la compétition du marché " – competition of the market.*)                                 |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| union, reunion (union, réunion)                                   | ?                               |                                                                                                                                                                                                                                     |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| psychological verbs (verbes psychologiques)                       | être? (mental states)           | écouter (*Le problème , on l' a dit, est de savoir comment mettre vraiment cela en pratique lorsque l'on constate une difficulté à se faire écouter.*)                                                                              |
|                                                                   |                                 |                                                                                                                                                                                                                                     |
|                                                                   |                                 | suivre (*les patientes seront contraintes de multiplier les déplacements pour se faire suivre.*)                                                                                                                                    |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| seizing, clasping, possessing (saisir, serrer, posséder)          | être? (stative)                 | élire (*avant que M. Hollande ne se fasse élire en affirmant qu'' il ne signerait pas le TSCG en l'' état.*)                                                                                                                        |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| communication                                                     | se faire ? (volitional)         | accuser (*il est devenu impossible de l'' exprimer dans le débat public sans se faire accuser de haïr les policiers*)                                                                                                               |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| auxiliary verbs                                                   | être? (stative)                 | \-                                                                                                                                                                                                                                  |
+-------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
-   (tagging @hundt_be-_2024 : simple, perfect, progressive; @bohmann_large-scale_2023 [39]: "Form of auxiliary verb: present, preterite, perfect, infinitive, -ing" OR progressive/non-progressive)

We summarise aspect (and tense) into two? levels: progressive and non-progressive ?

**levels**:

-   "progressive": imparfait, futur ?, periphrase constructions
...
Progressive category: emphasises ongoing or continuous actions, includes the imparfait, futur (in some contexts), and periphrastic constructions like *être en train de* + INF, *venir de* + INF or *aller* + INF.
...
**Alternative categories (Suggestion! - Rose)**

tense:

-   past/ present/ future: past favours être; present neutral (both), future favours se faire

-   OR binary: future/ non-future: future favours se faire; non-future favours être

aspect:

-   progressive/ non-progressive: progressive favours se faire, non-progressive favours être
...
-   **Negation:** @bohmann_large-scale_2023 [39]: *get* passive disfavoured in complex constructions (e.g. negation); parallel in French?
