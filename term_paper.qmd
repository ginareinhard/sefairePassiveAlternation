...
-   **Verb semantics (Aktionsart), Clusters** (@bohmann_large-scale_2023 [51-52]:
    ...
    -\> The *se faire* construction is generally considered incompatible with stative verbs and instead tends to occur with dynamic processes, focusing on cases where the source role is agentive and the target role is affected, which is the typical case of semantic transitivity. (@raineri_analyse_2010: 90).
...
-   lemma clustering method, not too many different levels because not each level will have enough data points: communication; don, privation; entrée, sortie; frapper, toucher; états physiques et comportements; locatif; mouvement sur place; munir, démunir; verbes psychologiques; réalisation, mise en état; saisir, serrer, posséder; transformation, changement; union, réunion; verbes auxiliaires @francois_presentation_2007 [4]

-   @bohmann_large-scale_2023 [44]: be predicted by more formal verbs encoding deontic/ menatl actions and changes in quality/ quantity; get preferred for physical motion, concrete actions, primarily negative verbs and low frequency verbs
...
-   physical states and behaviours
