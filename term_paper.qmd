...
Previous to conducting our study, we preregistered it on the platform "AsPredicted" to increase transparency and accountability [@huensch2024preregistration]. The preregistered study can be accessed here: <https://aspredicted.org/gp6y-dd8p.pdf>.
...
```{r data-cleaning-colnames-2, include = FALSE}
...
```{r merge-to-main-dataset, include = FALSE}
...
We classified the ϰ-values using the influential benchmark categorisation of @landis1977measurement [165], who define an agreement of 0.81 - 1.00 as "Almost Perfect". Mean inter-rater agreement was high at 0.84. Agreement was lowest for adversativity (0.67) and TAM (0.77).

## Binomial logistic regression

Levshina [-@levshina_how_2015: 253]: "logit represents the chances of construction A to be chosen in a particular type of context compared with the chances of construction B to be used in the same type of context."

### Levels

Levels are by default ordered alphabetically. We change the reference levels either to the most "standard" case, or, if this would negatively affect the stability of the model, to the most frequent case.
