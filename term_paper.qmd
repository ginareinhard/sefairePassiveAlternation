...
Thus, there exists extensive research on the alternation and their subtle differences. However, to our knowledge, so far no study has investigated the exacts factors predicting se faire over etre using logistic regression modelling. Logistic regression is popular in linguistic analysis due to its... and is specifically well-suited for linguistic analysis of alternations… has been successfully employed for investigation of passive variation on other languages for example by Hundt, Bohmann (English); Swedish (). Therefore, it promises to yield insightful results which will contribute to the discussion of… Our study aims to fill that research gap: by investigating the factors ...
