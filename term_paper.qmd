...
Both se faire + Vinf and être + Vé are available for the active diathesis [@novakova_construction_2009 [108]. However, as @novakova_construction_2009 [108] notes, the constructions differ in semantic nuances: "Elles ont un sens proche mais pas identique." Thus, they are not semantically identical but rather potentially carry different meanings which may be more or less pronounced depending on the context: Previous research suggests that se faire passive is more likely to have a causative undertone while the être passive is more neutral - possibility of a continuum/ passive gradient.

This introduces certain difficulties: The above discussed passive/ causative continuum makes the definition of the variable context particularly challenging as some constructions may be more passive than others - where to draw the line?
...
We recognize that the genre of parliamentary debates is quite specialised and therefore results therefore cannot be generalized to all French spoken language. However, the language of parliamentary debates a fascinating genre in itself (studied before: references) and is expected to reflect a wide range of topics, thus providing a cross-section of language varieties as they occur in French speech.
...
-   seed determined by future lottery numbers (5.3.2025?, <https://www.lotto.de/lotto-6aus49/lottozahlen>) → function set.seed( ) in R
...
As was to be expected based on the extensive debate on PSF's passive status (@sec-debate) and the challenges reported by @bohmann_large-scale_2023 in their investigation of the English be/get passive alternation we have come across a significant amount of somewhat "unclear" examples during manual filtering of se faire constructions.

Our main criterion was to include only constructions where a paraphrase with the être passive was possible, i.e. grammatical and similar in meaning. However, our somewhat "fuzzy" definition [@bohmann_large-scale_2023] brought about some challenges: When is something similar in meaning and still acceptable and when is the meaning too causative? We aimed to exclude purely causative constructions because they do not alternate with the être passive but have found many examples of se faire constructions cases where a binary passive/ causative distinction is not possible, for example because since the subject is both the undergoer and the causer.

In general, we have chosen a wide approach and have opted to include as many constructions as possible: That means that even if the causative reading appears more natural but there is a passive understanding because the subject undergoes an action it was included (goes against first criterion by @bellec_construction_2014). Examples for such verbs are "se faire vacciner" *to get vaccinated*, "se faire élire" *to get elected* included because although the subject is agentive and induces/ triggers the action, they also undergo it. Also we realize that some verbs could be causative in one context and passive in the other?? But for practical reasons, we decided on the verb lemma base whether to include or exclude and not indiviudally. For traceability, some high frequency unclear cases and our argumentation/ reasoning for our decision to include/ exclude (examples from corpus)

Manual filtering criteria:

Besides erroneously tagged constructions that are not real se faire + Vinf expressions (e.g.), we excluded expressions that do not not allow for a paraphrase with the être passive, either because they are ungrammatical or fundamentally differ in meaning. This includes:

-   Fixed idiomatic expressions with a figurative meaning: "se faire passer pour" *to impersonate, pretend to be sb.*, "se faire avoir" *to be fooled*, "se faire mousser" *to boast/ to brag, "se faire taper sur les doigts" lit. to get a slap on the fingers, to be scolded* ; example: "Dites donc, vous savez vous faire mousser!" *My, you know how to get yourself noticed!/ You know how to blow your own trumpet!*
...
-   Expressions with a transparent causative meaning: *On veut **nous faire croire** que tous ces braves gens qui vont revenir...* They want to **make us believe** that all the brave people...

-   expressions where an être passive has a very different meaning; example: attendre: “L’indemnisation se fait attendre” *The compensation is taking a long time to arrive/ is long overdue/ is a long time coming* vs. “être attendu” *to be expected;*
