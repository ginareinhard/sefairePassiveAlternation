...
The logistic regression outputted log odds, which were automatically converted to odds ratios through exponation by the `tab( )` function. However, we examined the log odds to identify tendencies of passive preference. Looking at the log odds of the significant variables, it becomes apparent that communication verbs boost the chance of [se faire]{.smallcaps} being used, while [être]{.smallcaps} is more likely in non-adversative contexts with inanimate subjects. (Although non-significant, feminine subjects are more likely to occur with [se faire]{.smallcaps} than masculine subjects.)
