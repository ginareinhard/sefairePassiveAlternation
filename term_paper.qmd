...
Regarding the factor of aspectuality, @keenan_passive_2007 [340] propose the following generalisation:
...
If we assume that [se faire]{.smallcaps} is a "basic passive", this suggests that the *être* and [se faire]{.smallcaps} have different aspectual preferences. Aspectuality is expressed through the verb, either via inherent lexical semantics ("Aktionsart") or grammatical marking, such as tense, aspect, and mood [^2] [@kortmann_triad_1991 : 13].
...
Our overall predictions regarding aspectuality is a preponderance for [se faire]{.smallcaps} for hitting-touching verbs and progressive aspect.
