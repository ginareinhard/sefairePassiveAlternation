...
@tbl-cluster-lemmas shows that the most frequent lemmas that occur with *se faire* are *insulter* (10 occurences), *engueuler* (7 occurences), and *représenter* (4 occurences). *insulter* and *engueuler* are both adversative verbs, so this could also be the reason why they favour *se faire*.
