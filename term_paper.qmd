...
Surprisingly, and contrary to our initial hypothesis, the only significant main effect in our model is the one of the semantic verb cluster, with communication verbs favouring [se faire]{.smallcaps} over [être]{.smallcaps}. We had predicted that hitting-touching verbs would favour [se faire]{.smallcaps}, given their dynamic and adversative nature, while communication verbs would be more compatible with [être]{.smallcaps}, as they typically feature an animate subject and frequently occur with object complements.

Specifically, the odds of [se faire]{.smallcaps} occurring with communication verbs are 7.18 times higher than with other verb types (CI: 1.34–38.58, p = 0.021). Looking at the most frequent lemmas in @tbl-cluster-lemmas, we find that *insulter* (10 occurrences), *engueuler* (7 occurrences), and *représenter* (4 occurrences) appear most often with [se faire]{.smallcaps}. Notably, *insulter* and *engueuler* are adversative, which may explain their preference for [se faire]{.smallcaps},

|                           |             |              |           |
|:--------------------------|:-----------:|:------------:|:---------:|
| Predictors                | Odds Ratios |      CI      |     p     |
| cluster \[communication\] |    7.18     | 1.34 – 38.58 | **0.021** |
