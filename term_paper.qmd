...
The "se faire" passive construction is available as an alternative way to express passive meaning: When constructing a passive sentence, the French speaker may choose to use "se faire" instead of the canonical "être", a passive alternation.
...
```{r reference-levels}
#example: change reference level from "animate" to "inanimate" (Levshina 2015: 78)
...
Function following @gries_statistics_2021 [442](& Elens Scripts)
