...
Both [se faire]{.smallcaps} and [être]{.smallcaps} are available for diathesis [@novakova_construction_2009: 108] and assign the subject function to the role of the undergoer (see @sec-etre, @sec-se-faire), therefore constituting a morphosyntactic alternation. We expect both passive variants to compete with each other, as we find that both variants may be used in the same context. An example from our sample is:

> 8.  *Je remarque d' ailleurs que ce sont souvent ceux qui filment qui **se font éborgnerou sont blessés** par des tirs de LBD*.\
