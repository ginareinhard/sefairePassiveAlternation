...
We tag animacy as binary *inanimate/ animate* although we recognize that animacy has been considered a hierarchical scale in the literature, most prominently by @zaenen_animacy_2004. Following @zaenen_animacy_2004, we understand organisations to be "collectivites of humans" and therefore annotate them as *animate*. In line with the literature, we hypothesise that both [se faire]{.smallcaps} and [être]{.smallcaps} favour animate subjects over inanimate subjects but subject animacy is a stronger predictor of [se faire]{.smallcaps} than of [être]{.smallcaps}.
