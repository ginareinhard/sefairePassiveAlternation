...
```{r full-passive-glmer, include = FALSE}
...
summary(full_passive_glmer) #AIC: 785.1
vif(full_passive_glmer)
```

```{r full-passive-glmer-tab, echo = FALSE}
tab_model(full_passive_glmer) # Marginal R2 / Conditional R2	0.598 / 0.746 // 0.704 / NA
```
...
Intercept: 2.97; meaning: chances of se faire are 2.073421 times greater than être given this context
