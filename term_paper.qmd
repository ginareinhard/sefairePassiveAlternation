...
-   levels: unknown, mixed, masculine, feminine

**Hypothesis**: (A feminine **agent** favours the *être* passive /disfavours the *se faire* passive??)

-   A feminine subject disfavors the *se faire* passive over the *être* passive? -\> if feminine referents are perceived as less active/agentive participants in the event (what about unknown/mixed?)
...
-   0: favours se faire passive

-   par: favours être passive

-   de: favours être passive (even more?); as the se faire passives favours dynamic, often adversative actions -\> interaction?
...
-   **TAM (Tense, Aspect, Mood)**
    ...
    -   **Aspect** tagging @hundt_be-_2024 : simple, perfect, progressive; @bohmann_large-scale_2023 [39]: "Form of auxiliary verb: present, preterite, perfect, infinitive, -ing" OR progressive/non-progressive
    ...
    -   **Mood:** indicative/ non-indicative (non-indicative = subjunctive, conditional, imperative)
...
Negation, subject number, subject gender
