...
The canonical passive with *être* in French inverts the syntactic functions of the arguments within a clause. The object of the active sentence, i.e. the undergoer, becomes the subject in the passive voice - a phenomenon known as diathesis. In French, the subject usually appears in the first position of a sentence. The *être* passive uses this syntactically salient position to shift the focus away from the actor and towards the undergoer.
