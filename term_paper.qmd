...
We only have categorical data; therefore mean and standard deviation are not meaningful. Descriptive statistics for each variable (following Elens textbook Chapter 8):
