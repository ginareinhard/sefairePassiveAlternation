...
Consequently, rather than coding tense, aspect, and mood as separate factors, we adopt a combined TAM category with two levels: progressive and non-progressive. This decision follows @bellec_construction_2014 \[210\], who argues that in French, tense and aspect are interrelated and jointly shape whether a clause is interpreted as progressive or not. Even in English, where these categories are formally distinct, recent studies have treated them as a combined category. For instance, @bohmann_large-scale_2023 [39, 49] grouped auxiliary verb forms (present, preterite, perfect, infinitive, *-ing*) into a broader category and found that present and preterite forms disfavoured [get]{.smallcaps} over [be]{.smallcaps}. Similarly, @hundt_be-_2024 [97] initially coded tense and aspect separately but ultimately interprets their effects together in terms of a TAM category.

Although tense, aspect, and mood are often summarised under the term TAM, in our analysis we focus exclusively on tense and aspect, as we assume that mood does not play a crucial functional role in the [être:se faire]{.smallcaps} alternation. Additionally, imperative constructions were excluded from the dataset (see @sec-filtering-criteria).
