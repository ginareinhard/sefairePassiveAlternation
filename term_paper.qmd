...
With regard to our hypotheses, although few significant effects were found, the strong interaction of subject animacy and adversativity clearly shows that [se faire]{.smallcaps} predominently occurs with animate subjects and in adversative contexts. Subject animacy seems to be the main mediating factor: [se faire]{.smallcaps} is very likely to occur with animate subjects in both adversative and non-adversative contexts, while its likelihood decreases significantly for inanimate subjects. This is in line with the vast previous evidence on [se faire]{.smallcaps}'s preference for animate subjects [@koenig_semantic_1992; @novakova_construction_2009: 111-112; @spang-hanssen_quelques_1967; @tasmowski-de_ryck_causatif_1987; @raineri_analyse_2010: 92]. However, our analysis challenges the claim by @tasmowski-de_ryck_causatif_1987 and @spang-hanssen_quelques_1967 that [se faire]{.smallcaps} strictly requires an animate subject: our data provide evidence that inanimate subjects can occur with [se faire]{.smallcaps} (`r   paste0(inanimate_sefaire_rel * 100, "%")`). Consequently, while our model predicts that while [se faire]{.smallcaps} has a high chance to occur with animate subjects, it may also be found with inanimate subjects, particularly in adversative contexts.

It is important to note that, as @kupferman_construction_1995 argues, even a strong correlation of animate subjects, adversative verbs and [se faire]{.smallcaps} does not necessarily imply that the subject is responsible for the event and brings negative consequences upon themselves. Rather, the increased likelihood of [se faire]{.smallcaps} with inanimate subjects in adversative contexts compared to non-adversative contexts suggests that the construction emphasises subject affectedness more than [être]{.smallcaps}. Note, however, that inter-annotator agreement was lowest for adversativity, indicating some ambiguity regarding the annotation of this factor, although it was still considered "substantial". Overall, we consider these findings to support the view that [se faire]{.smallcaps} is preferred over canoncial [être]{.smallcaps} when marking subject affectedness.

Although grammatical gender, like animacy, was tested as an aspect of subject responsibility or affectedness, it did not show a statistically significant effect in our logistic regression model, nor an interaction with animacy. For this reason, we do not draw any conclusions regarding gender, but consider the analysis of its absolute frequencies to be exploratory. In both passive variants in our sample, animate subjects are predominantly masculine, while inanimate subjects are more frequently feminine. [se faire]{.smallcaps}, which is often associated with higher subject responsibility or affectedness, occurs most frequently with animate masculine subjects, whereas [être]{.smallcaps} is more common with inanimate feminine subjects. This is consistent with our hypothesis that [se faire]{.smallcaps} is more typical for male subjects, suggesting a bias towards masculine subjects, with masculine subjects dominating in contexts of higher agency. In contrast, feminine gender appears more frequently as inanimate, possibly reflecting stereotypical associations with passivity or reduced agency.

For inanimate subjects, the difference in frequency between male and female is smaller, which might indicate that gender plays a lesser role in the absence of animacy. In our analysis, we did not distinguish between human and non-human referents. However, in previous work on French by @da2022objectifying, where female referents were shown to appear less likely as subjects than male referents, the syntactic gender bias was significant only when the referents were human. It is therefore possible that our broader animate/inanimate categorisation contributed to the lack of a significant gender effect. In addition, the number of [se faire]{.smallcaps} constructions with inanimate subjects was scarce in our dataset, which could also have influenced the significance of the effect. It is also worth noting that some subject NPs, such as *les personnes* 'the people/individuals', which is grammatically feminine but semantically gender-neutral and animate, are frequent in the data and may influence the interaction between gender and animacy. Such cases are worthy of further investigation in future work.

The other factors used to operationalise subject responsibility in our model - the presence of a *complément d'agent* and the use of a modal verb - also yielded no significant effects. This lack of other significant effects relating subject responsibility could further support the interpretation that [se faire]{.smallcaps} is more strongly related to the subject's affectedness than its responsibility. It is also worth mentioning that our annotation of modality was limited to modal verbs; other constructions expressing subject involvement or volition, such as *avoir besoin de*, *arriver à*, *réussir à*, *envier de*, *avoir des difficultés pour*, *avoir la possibilité de*, and *avoir envie de*, were not considered. These expressions, however, these expressions were markedly frequent in connection with [se faire]{.smallcaps} during the annotation process and may be worth considering in future research to further investigate the relationship between subject responsibility and the use of [se faire]{.smallcaps}.

The finding regarding aspectuality in our logistic regression model is unexpected and contradicts our initial hypothesis. The model shows a significant effect for the semantic verb cluster, with communication verbs significantly favouring [se faire]{.smallcaps}, which contrasts with our expectation that [être]{.smallcaps} would be more likely in these contexts. We could not explain this result, as no significant interactions were found. The relationship between verb cluster and adversativity, as well as subject animacy, may be more complex than initially anticipated, or our dataset may not have been optimally suited to detect a significant effect.

Seeking an explanation within our theoretical framework, we examined the most frequent communication verb lemmas occuring with [se faire]{.smallcaps} in our sample. The two most frequent lemmas (*insulter* and *engueuler*) carry a dynamic and adversative nuance and typically take an animate undergoer. These verbs may therefore behave similarly to hitting-touching verbs, emphasising the subject’s affectedness. This could be supported by the finding that [se faire]{.smallcaps} is more frequent with hitting-touching verbs than [être]{.smallcaps}, but this effect is also not statistically significant. Alternatively, other factors not considered in our analysis may account for these findings. Such factor could e.g. be register and medium: [se faire]{.smallcaps} is predominantly used in informal contexts [@raineri_analyse_2010: 87], whereas [être]{.smallcaps} is more frequently used in written than in spoken French [@da2022alternance: 76-77]. Verbs like *insulter* and *engueuler* could also be more typical of colloquial speech.

An alternative explanation for this result regarding verb clusters is the inherent lexical properties of the verbs. In our model, the random intercept for `lemma` (τ₀₀ = 1.94) indicates a substantial contribution to model variance, suggesting that certain verbs are more likely to occur with [se faire]{.smallcaps} due to their lexical properties. This aligns with Bohmann et al.’s findings [-@bohmann_large-scale_2023: 48] that English [get]{.smallcaps} is largely lexically determined. It emphasises the important role of lexical effects in the occurrence of [se faire]{.smallcaps}. We believe that the application of memory-based learning methods, such as k-nearest neighbour classifiers, could provide more insights into the lexical conditioning of [se faire]{.smallcaps}, as they capture lexical properties without requiring explicit rule-based abstractions (**source?**).

In terms of aspectuality and TAM, our model did not yield any significant effects. This result contradicts previous observations, such as those by @bellec_construction_2014 [209], who notes that [être]{.smallcaps} is more likely to describe an outcome or endpoint, while [se faire]{.smallcaps} is more likely to occur with verbs referring to progressive or ongoing actions. Based on this, we had expected progressive aspect to favour [se faire]{.smallcaps}. In our analysis, TAM was broadly grouped into two categories: "progressive" and "non-progressive". We chose this approach facilitate our annotation and it was necessary to ensure inter-annotator agreement, especially as neither annotator was a native French speaker, but it may also have led to limitations. The annotation may not have been fine-grained enough to capture subtler aspectual nuances. This may partly account for the lack of a significant TAM effect in our results.

Another aspectual factor not included in our annotation is telicity. According to @bellec_construction_2014 [209], [être]{.smallcaps} is likely to describe a result or mark the endpoint of an action, whereas [se faire]{.smallcaps} is typically used for ongoing actions or verbs that are inherently ongoing (e.g. perception verbs). This could be reflected in the telicity of the verb, with telic verbs favouring [être]{.smallcaps} and atelic verbs favouring [se faire]{.smallcaps}. This pattern could also overlap with the verb cluster factor. Telicity would be a valuable addition for future research.

One general limitation of our dataset is that the predictions of our model do not fully reflect actual language use, as [être]{.smallcaps} is far more frequent than [se faire]{.smallcaps}. In the ParlaMint 2.1 corpus, [être]{.smallcaps} occurs 324,836 times (**38.300 in ?**), compared to just 1,254 instances of [se faire]{.smallcaps}. To prevent the model from being skewed, we created a balanced dataset based on the lemmas occuring with [se faire]{.smallcaps}[^4]. While this approach allowed us to focus on the factors influencing the passive alternation, it introduced an artificial ratio that does not represent real-life language use, where [être]{.smallcaps} is the unmarked default passive and [se faire]{.smallcaps} is a marked and rare variant. Additionally, selecting lemmas based on their occurrence with [se faire]{.smallcaps} may have biased the lexical distribution towards verbs that are particularly compatible with [se faire]{.smallcaps}, thereby limiting the generalisability of our findings. Also, by removing all occurrences annotated as "unknown" gender from our dataset, we addressed potential bias and collinearity in our logistic regression model. However, this resulted in an imbalance between the numbers of occurrences of [être]{.smallcaps} and [se faire]{.smallcaps}. Training the model on this unbalanced data may have limited the generalisability of our results. Additionally, selecting lemmas based on their occurrence with [se faire]{.smallcaps} may have biased the lexical distribution towards verbs that are especially compatible with [se faire]{.smallcaps}, limiting the generalisability of our findings. We also excluded all occurrences with "unknown" gender to avoid potential bias and collinearity in the model. However, this led to an imbalance in the number of [être]{.smallcaps} and [se faire]{.smallcaps} constructions in the final dataset, which may have further limited the generalisability of our results.
...
**Despite these limitations, the model diagnostics offer additional insight into the...? of our model.**

-   **potential problems revealed in diagnostics: suboptimal fit for some data (binned residuals)**

The bootstrapping results provide additional insight into the reliability of our model. While the original model shows a reasonable overall fit, the resampling procedure reveals some problems with model stability. Most notably, convergence warnings occurred in the majority of bootstrap iterations - especially singularity. These problems could only be resolved by switching to the bobyqa optimiser, suggesting that the structure of the random effects, particularly the talker effect, may be difficult to estimate reliably with our data. Removing the talker effect completely eliminated the convergence problems, but at the cost of a higher AIC (732.0 vs. 719.2), indicating a poorer fit of the model overall. So we chose a trade-off between model stability and completeness/accuracy? Although we retain the original model for interpretation, we recognise its limitations in terms of robustness. The simplified version without speakers (see Table 9) could serve as a more stable alternative and could be further investigated in future work. The bootstrap statistics show minimal bias for most fixed effects, which speaks in favour of their stability. However, subj_animacyinanimate stands out with a slightly higher bias (-0.051) and its distribution deviates from a bell curve, suggesting lower reliability. This could also affect the interaction involving this variable. In contrast, the significant main effect clustercommunication shows a stable, bell-shaped distribution centred around the original estimate. Nevertheless, both verb cluster predictors (communication & hitting-touching) have higher standard errors, which indicates a certain degree of uncertainty despite their apparent robustness.
