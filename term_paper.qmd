...
Specifically, the odds of [se faire]{.smallcaps} occurring with communication verbs are **7.18 times higher** than with verb in the "neutral" category (CI: 1.34–38.58, p = 0.021). In contrast, hitting-touching verbs, which we expected to strongly favour [se faire]{.smallcaps}, did not show a significant effect. \[**Refer to Figure X for an overview of the model predictions.\], refer to plot & odds of hitting-touching**
