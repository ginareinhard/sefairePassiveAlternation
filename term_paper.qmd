---
title: "The French Passive Alternation: A Corpus-Based Study (of être and se faire) | A Corpus-Based Analysis of the French Passive Alternation"
subtitle: ""
...
-   Writing-Original Draft (including Code)
    ...
    -   3.1.1, 3.1.2, 3.1.3; 3.2.3 (Bootstrap Validation)
...
-   Visualisation / Preparation, creation and/or presentation of the published work, specifically visualization/ data presentation
    ...
    -   (Figure 1), Figure 5, Figure 6, Figure 7, Figure 8?, Figure 10, Figure 11, Figure 12
...
-   Writing - Original Draft (including Code)
    ...
    -   @sec-se-faire: @sec-sefaire-structure-meaning, large parts of @sec-debate; @sec-factors: @sec-sefaire-context, @sec-subj-resp (Intro Subject Responsibility, Subject Animacy, Modal Verb), @sec-adversativity, contributions to Tense-Aspect-Mood (TAM) in @sec-aspectuality

    -   @sec-data-collection: @sec-corpus, @sec-semi-automatic-approach, @sec-iaa, @sec-data-preprocessing, contributions to @sec-filtering-criteria; all of @sec-log-regression except bootstrap validation
...
-   Writing - Review & Editing: throughout the whole paper, especially in Discussion
...
-   Project administration) -->
```
For a full overview of the exact contributions of each author, please consult our Git repository: ...
