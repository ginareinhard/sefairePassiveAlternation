...
Previous literature has established that grammatical aspect influences the [être:se faire]{.smallcaps} alternation. According to @raineri_analyse_2010 \[356ff.\], among the various factors commonly associated with [se faire]{.smallcaps}, such as subject animacy, subject responsibility, and adversativity, the only necessary condition for its occurence is the type of process referred to by the verb. In her corpus, nearly all [se faire]{.smallcaps} constructions involve dynamic processes. She argues that [se faire]{.smallcaps} conveys an inchoative or durative perspective, emphasising the onset or unfolding of the event and the moment the subject begins to be affected. In contrast, she describes [être]{.smallcaps} as more typically presenting the event in its entirety, without an internal viewpoint. @raineri_analyse_2010 \[356ff.\] also observes a comparable distinction for the English [be]{.smallcaps}:[get]{.smallcaps} passive alternation. Similarly, @bellec_construction_2014 [209] notes that [se faire]{.smallcaps} is often used with verbs denoting progressive or ongoing actions, whereas [être]{.smallcaps} is more likely to describe a result or endpoint.

Tense and aspect in French are interdependent and cannot be clearly separated. Because of this interrelation, we treat them as a single combined factor to simplify the analysis. For example, in constructions using the *passé composé*, the focus tends to be on the completed event, which may increase the likelihood of using [être]{.smallcaps} over [se faire]{.smallcaps}. In contrast, the *imparfait*, which emphasises the ongoing process, may favour [se faire]{.smallcaps} over [être]{.smallcaps}. In the present tense, we expect both passive variants to be evenly distributed, as the present tense does not emphasise either the endpoint or the process. Descriptions of future events tend to highlight the beginning and ongoing process of an action, rather than its endpoint [@bellec_construction_2014: 210]. We therefore anticipate that the future tense will favour [se faire]{.smallcaps} over [être]{.smallcaps}.

Although tense, aspect and mood are often summarised under the term TAM, in our analysis we focus exclusively on tense and aspect. This decision is based on the assumption that mood does not play a crucial functional role in the [être:se faire]{.smallcaps} alternation. Additionally, imperative constructions were excluded from the dataset (see @sec-filtering-criteria).

According to @spang-hanssen_quelques_1967 [141] and Novakova [-@novakova_construction_2009: 115], periphrases that denote progressivity, such as *être en train de* + INF, *venir de* + INF and *aller* + INF, occur more naturally with [se faire]{.smallcaps} than with [être]{.smallcaps}. This is because [se faire]{.smallcaps} conveys a dynamic, ongoing action compared to the more stative [être]{.smallcaps}. (also: @bellec_construction_2014; @keenan_passive_2007 \[341\], @raineri_analyse_2010 [91]
...
-   regarding aspectuality
    ...
    -   @bellec_construction_2014 [209] similarly notes that [être]{.smallcaps} is more likely to describe a result or endpoint, whereas [se faire]{.smallcaps} is often used with verbs denoting progressive or ongoing actions, such as perception verbs.
...
[^4]: Note that the ratio ended up not being exactly 50:50 because we chose to exclude the gender 'unknown' which removed 165 se faire and only 29 être constructions. However, this is is still much more balanced than the actual ratio.
