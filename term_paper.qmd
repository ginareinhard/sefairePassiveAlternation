...
|-------------------------------------|------------------|------------------|
| giving, depriving (don, privation) | se faire |  |
| entering, leaving (entrée, sortie) | se faire |  |
| hitting, touching (frapper, toucher) | se faire |  |
| movement in place (mouvement sur place) | se faire |  |
| equipping, disarming (munir, démunir) | se faire |  |
| transformation, change (transformation, changement) | se faire |  |
| realisation, preparation (réalisation, mise en état) | se faire |  |
| physical states and behaviours (états physiques et comportements) | être |  |
| locative (locatif) | être |  |
| union, reunion (union, réunion) | ? |  |
| psychological verbs (verbes psychologiques) | être? (mental states) |  |
| seizing, clasping, possessing (saisir, serrer, posséder) | être? (stative) |  |
| communication | se faire ? (volitional) |  |
...
-   **TAM (Tense, Aspect, Mood)**
    ...
    -   **Mood:** indicative/ non-indicative (non-indicative = subjunctive, conditional, (imperative)) // realis/ irrealis
