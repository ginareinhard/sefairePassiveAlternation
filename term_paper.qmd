...
etre_sample_1 <- read.csv(file = here("data", "etre_sample_1.2.csv"))
etre_sample_2 <- read.csv(file = here("data", "etre_sample_2.2.csv"))
etre_sample_3 <- read.csv(file = here("data", "etre_sample_3.2.csv"))
etre_sample_4 <- read.csv(file = here("data", "etre_sample_4.2.csv"))
```
...
write.csv(etre_sample_randomised,"./data/etre_sample_random.csv")
