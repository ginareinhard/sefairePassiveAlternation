...
summary(passive_glmer_without_unknown) #AIC: 785.1 
tab_model(passive_glmer_without_unknown) # Marginal R2 / Conditional R2	0.598 / 0.746 // 0.704 / NA
...
summary(final_model_without_unknown)
tab_model(final_model_without_unknown) 
vif(final_model_without_unknown)
```

significant effects in model_2 (final model?):

-   cluster\[communication\];

-   subj animacy \[inanimate\] × subj gender \[unknown\];
...
# C 0.9549516 - pretty good I think? "outstanding discrimination" according to Hosmer & Lemeshow (2000: 162) in Levshina (2015: 259)
```
