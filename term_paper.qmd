...
As outlined in @sec-subj-resp, subject animacy is related to subject responsibility or subject affectedness. In our data, inanimate subjects were more frequent than animate ones with [être]{.smallcaps} (38% animate, 62% inanimate), whereas [se faire]{.smallcaps} showed a strong preference for animate subjects (93% animate, 7% inanimate).
