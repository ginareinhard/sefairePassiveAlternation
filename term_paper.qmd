...
The impersonal passive (*passif impersonnel*) is available for some verbs without a complément direct (*Il a été ri de cette histoire.*). With impersonal passives, the direct object can remain as a complement, as in *Il sera acheté un livre* (‘A book is bought’) (GGF 210).
...
-   the passive turn takes only one affected entity as its subject, unlike the causative construction (according to Labelle 2002) (se faire)
