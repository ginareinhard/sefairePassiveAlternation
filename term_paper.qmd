...
We are also aware that some verbs can be paasive in one context and causative in another and have come across such examples (e.g."se faire remarquer" *to get noticed, also: to draw attention to oneself).* But for practicality, we decided to include or exclude them on the basis of the verb lemma, rather than individually. For traceability, below are some high frequency ambiguous cases and our argumentation/ reasoning for our decision to include/ exclude them.
...
We tag animacy as binary "inanimate"/ "animate" although we recognize that animacy has been considered as a hierarchical sclae in the literature, most prominently by @zaenen_animacy_2004.
