...
However, constructions like 5b. count are especially controversial. Some scholars argue that such instances of [se faire]{.smallcaps} are fundamentally causative rather than passive, since the subject both initiates and undergoes the action (as in: "Pierre made the hairdresser cut his hair"). This debate will be outlined in @sec-debate.
...
As implied in the debate on subject responsibility, subjects of [se faire]{.smallcaps} are predominantly active participants in the described action. Since inanimate subjects are rarely affected and even less often responsible, [se faire]{.smallcaps} is common with animate subjects. While some scholars claim that only animate subjects are possible with the [se faire]{.smallcaps}, others provide counterexamples (cf. @labelle_anticausativizing_2013, @kokutani_sur_2005, @novakova_construction_2009 \[4\], @sveberg_se_2012) (@raineri_analyse_2010 [92]).
...
[se faire]{.smallcaps} tends to occur with dynamic processes, focusing on cases where the source role is agentive and the target role is affected, which is the typical case of semantic transitivity [@raineri_analyse_2010 90, 238]. Multiple hypotheses are found in the literature concerning the compatibility of certain verbs with [se faire]{.smallcaps}. For example, @kupferman_construction_1995 \[67\] and @raineri_analyse_2010 [90] state that [se faire]{.smallcaps} works well with dynamic verbs but not with stative verbs or verbs of state change with an external "cause" argument, although exceptions are provided by @novakova_construction_2009 **pages?**, @martin_construction_2002 **pages?** and @raineri_analyse_2010 [100-103].

However, @martin_construction_2002 [14] argues that a source can induce a change of state without intentionality and should therefore be classified as an "effector" rather than an agent. To support this argument, she points out that while example 1.a is ungrammatical, 1.b is more acceptable, suggesting that the role of the source does not necessarily imply agency:
...
She also argues that [se faire]{.smallcaps} with psychological verbs, such as in *Elle s'est fait séduire par Pierre* 'She was seduced by Pierre', is not always causative but can have a passive reading. @novakova_construction_2009 also notes that while rare, [se faire]{.smallcaps} with stative verbs can sometimes be interpreted passively, as in *Il peine encore à se faire aimer par tous les siens* 'He still struggles to be loved by all his own'.

The semantic class of the verb has been shown to play a crucial role in the use of the passive voice in oral French [@da2022alternance] and in the alternation between [be]{.smallcaps} and [get]{.smallcaps} passives in English [@bohmann_large-scale_2023]. Following @da2022alternance, we include the semantic class of the verb lemma as a factor in our analysis, using the classification in the online dictionary "Les Verbes Français - LVF" [@lvf]. **TableX** in the @appendix presents the French verb clusters established by @francois_presentation_2007, on which this dictionary is based, along with language examples from our dataset.

In the corpus study by @da2022alternance, **85%** of *frapper* class verbs ('hitting-touching' verbs describing violent actions) occurred in passive constructions, while only **15%** were used in the active voice. This is consistent with findings from journalistic English, where verbs describing violent actions are frequently used in the passive voice [@henley1995syntax] **and Bohmann?**. According to @da2022alternance, this preference can be explained by two factors: (1) the topical character of the undergoer affected by a hitting-touching action, which makes it more likely to be promoted to the subject position, and (2) the possibility to omit an unknown or less salient agent, which aligns with the concept of subject responsibility. We expect this effect to hold for [se faire]{.smallcaps} as well. Even though both [se faire]{.smallcaps} and [être]{.smallcaps} topicalise the undergoer, [se faire]{.smallcaps} typically implies some degree of subject involvement, so highly dynamic verbs such as *frapper* might increase the likelihood that it is favoured over [être]{.smallcaps}, where the subject is a more passive patient.

As shown in @fig-clusters, in the study by @da2022alternance on oral French some verb clusters showed no clear effect on passive frequency, with approximately equal distributions of active and passive forms (e.g. verbs of perception, cognition, psychological states, behaviour, movement and transfer). Locative and communicative verbs, on the other hand, appeared more frequently in the active voice. The preference for active constructions was not statistically significant for location verbs, while the probability of communication verbs occurring in the active was significantly higher.
...
@da2022alternance suggest that this tendency can be explained by the verbal disposition hypothesis by @stallings1998phrasal, according to which verbs show a preference for certain syntactic constructions that speakers store in their mental lexicon. Communicative verbs frequently occur with object complements, which rarely function as subjects. Since the active voice allows these verbs to maintain the object complement, they naturally favour active constructions over passive ones. @thuilier2012lemme makes a similar argument regarding communicative verbs and postverbal complements. Additionally, communicative verbs often feature an animate or human actor, which is more likely to be encoded as the subject in active constructions [@da2022alternance].
...
**However, this effect could interact with other factors:** - Animacy and verb clusters: The choice of passive construction could be influenced not only by the verb cluster alone, but by the combination of these two factors: e.g. animacy could have a stronger effect if the verb is from the hitting-touching category or the neutral category ("se faire" could be strongly favoured with animate subjects compared to inanimate subjects), while this effect could be weaker with communicative verbs for which "être" passive could be favoured regardless of animacy.\
Adversativity could reinforce "se faire" more in communication and neutral verbs than in hitting-touching verbs: Communication verbs tend to favour "être" and neutral verbs have no strong preference, but adversative constructions may shift both toward "se faire". Since hitting-touching verbs are inherently highly adversative, adversativity is unlikely to strongly affect their passive preference.
...
```{r adversativity-tab, include = FALSE}
...
Regarding the interaction between animacy and adversativity, both adversative and non-adversative constructions with [se faire]{.smallcaps} were used more frequently with animate subjects, while [être]{.smallcaps} constructions were more common with inanimate subjects in non-adversative contexts. The interaction is explored in detail in @sec-results-log-effects.
...
## Effects of logistic regression {#sec-results-log-effects}

Reporting and interpreting results of the logistic regression with regard to our hypotheses and descriptive statistics
...
As @fig-animacy-adversativity-log illustrates, the likelihood of [se faire]{.smallcaps} being used with inanimate subjects increases significantly when the construction has an adversative meaning: [se faire]{.smallcaps} and [être]{.smallcaps} are equally likely for inanimate subjects in adversative contexts, whereas in non-adversative contexts, [être]{.smallcaps} is almost always preferred. In contrast, constructions with animate subjects strongly favor [se faire]{.smallcaps}, with a slight additional increase in its likelihood in adversative contexts.

# Discussion

Reflecting the many-faceted (and partly conflicting) literature on the French passive construction and especially on [se faire]{.smallcaps}, our study has shown that passive is a complex and nuanced construct. This entails some challenges for the systematic study of both passive alternations generally, and of [se faire]{.smallcpas}: [être]{.smallcaps} specifically. Firstly, the variable context of the is necessarily quite loose due to [se faire]{.smallcaps} adjacency to the formally (syntactically) identical causative construction. As has been shown, several borderline cases exist which can take both causative and passiv meaning depending on the specific context. Similarly, [être]{.smallcaps} may constructions range between the statal passive and the progressive passive, with the statal passive sometimes being undistingushable from and adjectival construction. Decisions had to made with regard to which constructions to include and which to exclude; however, a different set of choices could be just as justified and would likely have produced substantially different results.

With regard to our hypotheses, although not many significant effects were found, the strong interaction of subject animacy and adversativity clearly hints at the preponderance of [se faire]{.smallcaps} to be utilised with an animate subject. Animacy seems to be the main mediating factor since [se faire]{.smallcaps} was likely for animate subjects both in adversative and non-adversative contexts while its likelhood decreased drastically for inanimate subjects (although inanimate subjects in adversative contexts were more likely than in inadversative contexts); supporting the notion of Gaatone of an "active patient".

However, in line with @kupferman, this does not necessarily mean that the subject is responsible for the event and brings the negative consequences onto themselves. Rather, the fact that adversativity also significantly increased the likelihood of se faire being used supports a theory of subject affectedness being pronounced/ emphasised by the use of [se faire]{.smallcaps} over [être]{.smallcaps}. (However, note that inter-rater agreement was lowest for adversativity - indicating unclarity regarding this factor (although still "substantial"))

was the interaction effect of animacy and adversativity: shows that se faire strongly prefers animate subjects: likely with both adversative and non-adversative contexts while for inanimate subjects, inadversative constructions are much less likely to occur with se faire than adversative and constructions. (However, note that inter-rater agreement was lowest for adversativity - indicating unclarity regarding this factor (although still "substantial")) potential reason: not enough data?
