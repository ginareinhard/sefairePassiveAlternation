...
Corpus studies have shown that animacy significantly influences voice choice in French. The animacy of the undergoer (i.e. the direct object in the active voice and the subject in the passive) has been shown to increase the likelihood of using [être]{.smallcaps} over the active voice [@da_cunha_lalternance_2020; @da2022alternance]. According to @da_cunha_lalternance_2020 and @da2022alternance, animate referents are more salient than inanimate ones, which makes them more likely to be promoted to subject position. In parallel, we also expect the animacy factor may to play an important role in the distribution of [se faire]{.smallcaps} in relation to subject responsibility.
