...
Reflecting the multifaceted (and partly conflicting) literature on the French passive construction and especially on [se faire]{.smallcaps}, our study has shown that passive is a complex and nuanced phenomenon. This entails some challenges for the systematic study of both passive alternations in general, and of [se faire]{.smallcaps} and [être]{.smallcaps} specifically. Firstly, the variable context is necessarily broad due to [se faire]{.smallcaps}'s adjacency to the formally (syntactically) identical causative construction. As has been shown, several borderline cases be interpreted as either causative or passive meaning depending on the specifc context. Similarly, [être]{.smallcaps} constructions may range between the stative passive and the progressive passive, with the former sometimes being undistingushable from adjectival constructions. Decisions had to be made regarding inclusion and exclusion criteria; however, a different set of choices could have been equally justified and might have yielded different results.

With regard to our hypotheses, although few significant effects were found, the strong interaction of subject animacy and adversativity clearly hints at the preponderance of [se faire]{.smallcaps} to be utilised with animate subjects. Animacy seems to be the main mediating factor since [se faire]{.smallcaps} was likely for animate subjects both in adversative and non-adversative contexts while its likelihood decreased significantly for inanimate subjects (although inanimate subjects in adversative contexts were more likely than in non-adversative contexts); supporting @gaatone_desagreable_1983 's the notion of an "active patient".

However, as @kupferman_construction_1995 argues, this does not necessarily mean that the subject is responsible for the event and brings negative consequences upon themselves. Rather, the fact that adversativity also significantly increased the likelihood of [se faire]{.smallcaps} being used with inanimate subjects supports the idea that [se faire]{.smallcaps}, more than [être]{.smallcaps}, emphasises subject affectedness. Notably, inter-rater agreement was lowest for adversativity, suggesting some ambiguity regarding this factor, although it was still considered 'substantial'.
