...
This section is divided into three parts, corresponding to the main concepts: subject responsibility, adversativity, and aspectuality. Contrary to our original hypotheses, the only significant main effect is found for the semantic verb cluster, with communicative verbs favouring [se faire]{.smallcaps} over [être]{.smallcaps}. In addition, the model shows a significant interaction between subject animacy and adversativity. @tbl-frequencies summarises the absolute and relative frequencies for each factor level, with the relative frequencies calculated on the basis of the total number of occurrences of [être]{.smallcaps} or [se faire]{.smallcaps}, respectively.
