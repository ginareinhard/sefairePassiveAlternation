...
Corpus studies have shown that animacy significantly influences voice choice in French. The animacy of the undergoer has been shown to increase the likelihood of using [être]{.smallcaps} over the active voice [@da_cunha_lalternance_2020; @da2022alternance]. In parallel, we also expect the animacy factor may to play an important role in the distribution of [se faire]{.smallcaps} in relation to subject responsibility.
