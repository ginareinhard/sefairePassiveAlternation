...
-   as @bohmann_large-scale_2023, we have faced difficulties in defining the variable context and had to rely on a fuzzy context. In general, we have chosen a wide approach and have opted to include as many constructions as possible: That means that even if the causative reading appears more natural but there is a passive understanding because the subject undergoes an action it is included. For traceability, some unclear cases and our argumentation/ train of thought/ reasoning for our decision to include/ exclude (examples form corpus)
