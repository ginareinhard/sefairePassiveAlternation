...
etre_sample <- rbind(etre_sample_1, etre_sample_2, etre_sample_3)

```

```{r randomization, include=FALSE}

set.seed(2142637384) #lottery numbers too long, deleted last digit

etre_sample_randomized <- etre_sample |>
  slice_sample(n = 700)
...
```{r être-lemma-list, include = FALSE}

être_sample_full <- rbind(être_sample_1.csv,être_sample_2.csv)
