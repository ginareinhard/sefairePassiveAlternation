...
**The remaining factors used to test subject responsibility (subject gender, complement d'agent, modal) did not yield significant effects.** <!-- This may be taken as further indication for .../ The absence of additional significant effects related to subject responsibility may further support this notion. --> **This may further strengthen an argument against subject responsibility and in favour of subject affectness.**
...
For inanimate subjects, the difference in frequency between male and female is smaller, which might indicate that gender plays a lesser role in the absence of animacy. In our analysis, we did not distinguish between human and non-human referents. However, previous work by **Da Cunha and Abeillé** has shown that this distinction can significantly influence the active/passive alternation in French. It is therefore possible that our categorisation of animate/inanimate contributed to the lack of a significant gender effect. In addition, the number of [se faire]{.smallcaps} constructions with inanimate subjects was scarce in our dataset, which could also have influenced the significance of the effect. It is also worth noting that some subject NPs, such as *les personnes* 'the people/individuals', which is grammatically feminine but semantically gender-neutral and animate, are frequent in the data and may influence the interaction between gender and animacy. Such cases are worthy of further investigation in future work.

-   no effects of tam and modal: summarising tense aspect and mood in a TAM category of "progressivity" with strict classification of tenses (although sometimes not fitting in context) potentially problematic (but also needed to ensure inter-annotator agreement and limited by the fact that neither of the authors is a native speaker of French) - overall labeling maybe not nuanced enough? The "modal" category in our study only includes modal verbs. Other similar constructions that express subject responsibility, such as *avoir besoin de*, *arriver à*, *réussir à*, *envier de*, *avoir des difficultés pour*, *avoir la possibilité de*, and *avoir envie de*, etc. could also be interesting to examine in future research.

The finding regarding aspectuality in our logistic regression model was unexpected and contrary to our initial hypothesis. The model shows a significant effect for the semantic verb cluster, with communication verbs significantly favouring [se faire]{.smallcaps}, which contrasts with our expectation that [être]{.smallcaps} would be more likely in these contexts. We could not explain this, as the interactions of verb cluster were neither significant for animacy, nor for adversativity. One possible explanation could have been that certain communication verbs, particularly those with an adversative nuance like *insulter* and *engueuler*, pattern similar to hitting-touching verbs, emphasising the subject’s affectedness.

Another possible explanation: communication verbs like *insulter* and *engueuler*, which are most frequent with [se faire]{.smallcaps} are dymanic and adversative, making them more likely to occur with [se faire]{.smallcaps} rather than the more neutral [être]{.smallcaps}. -\> [se faire]{.smallcaps} is also more frequent with hitting-touching verbs but non-significant
...
Alternatively, this could reflect a more general tendency for [se faire]{.smallcaps} to appear in contexts where the subject is undergoing an action with a certain intensity, which might be more common with communication verbs than initially assumed?

Maybe another possible influence: [se faire]{.smallcaps} is more likely in informal settings, [être]{.smallcaps} more likely in formal settings (**source**) -\> communication verbs like *insulter* and *engueuler* are also colloquial
...
By removing all occurrences annotated as "unknown" gender from our dataset, we addressed potential bias and collinearity in our logistic regression model. However, this resulted in an imbalance between the numbers of occurrences of [être]{.smallcaps} and [se faire]{.smallcaps}. Training the model on this unbalanced data may have limited the generalisability of our results.
